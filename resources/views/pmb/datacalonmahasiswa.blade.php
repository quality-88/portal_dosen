...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-4">Data Calon Mahasiswa S1</h4>
                    <form class="row g-5" action="#" method="POST">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="ta" name="ta" value="{{ old('ta', $ta ?? '') }}" required min="2023">
                        </div>
...
<script>
    ...
    function downloadPDF() {
        ...
        doc.text('Data Calon Mahasiswa S1', 300, 50);
        doc.setFontSize(15);
        doc.text(`Tahun Ajaran: ${ta}`, 340, 80);
        $no = 1;
        var data = [];
        var headers = ['No', 'Nama', 'Email', 'HP', 'Alamat Asal','Asal SMU'];
        @foreach($results as $result)
        var row = [
            $no++,
            '{{ $result->nama }}',
        ...
        const fileName = `Daftar Calon Mahasiswa S1_${universitas}_${ta}_${formattedDate}.pdf`;
        doc.save(fileName);
    }
    ...
    function downloadExcel() {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Data Calon Mahasiswa S1");
    
        var ta = document.getElementById('ta').value;
       
        var universitas = document.getElementById('universitas').value;
        var fileName = `Data Calon Mahasiswa S1-${universitas}_${ta}.xlsx`;
