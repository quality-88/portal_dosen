        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr class="my-3">
                    <form method="POST" action="{{ route('editInpassing') }}" class="forms-sample">
                        @csrf
                            ...
                            <div class="mb-3 col-md-7">
                                ...
                                <select class="form-select" id="pangkat" name="pangkat" aria-label="Default select example" required>
                                    ...
                                    @foreach($allPangkat as $data)
                                        <option value="{{ $data->keterangan }}" data-golongan="{{ $data->golongan }}"
                                            {{ $data->keterangan == $inpassing->NamaInpassing ? 'selected' : '' }}>
                                            {{ $data->keterangan }} - {{ $data->golongan }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!--<div class="mb-3 col-md-7">
