...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Ijin Belajar</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-0">Edit Ijin Belajar</h4>
                    <hr class="my-3">
                    <form method="POST" action="{{ route('editIjinBelajar') }}" class="forms-sample">
                        @csrf
                      <!-- Input tersembunyi untuk menangkap idDosen dari URL -->
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-7">
                                ...
                                <input type="text" name="nidn" class="form-control" id="nidn" placeholder="nidn" 
                                value="{{ $ijin->NIDN }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="berizin" class="form-label">IZIN </label>
                                <input type="text" name="berizin" class="form-control" id="berizin" placeholder="berizin" 
                                value="{{ $ijin->BERIZIN }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                ...
                                value="{{ $ijin->NOSK }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="tahunmulai" class="form-label">Tahun Mulai</label>
                                <input type="text" name="tahunmulai" class="form-control" id="tahunmulai" placeholder="tahunmulai" 
                                value="{{ $ijin->TAHUNMULAI }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="namapt" class="form-label">Nama PT</label>
                                <input type="text" name="namapt" class="form-control" id="namapt" placeholder="namapt" 
                                value="{{ $ijin->NAMAPT }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="kota" class="form-label">Kota</label>
                                <input type="text" name="kota" class="form-control" id="kota" placeholder="kota" 
                                value="{{ $ijin->KOTA }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="keterangan" class="form-label">Keterangan</label>
                                <input type="text" name="keterangan" class="form-control" id="keterangan" placeholder="keterangan"
                                value="{{ $ijin->KETERANGAN }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="sumberdana" class="form-label">Sumber Dana</label>
                                <input type="text" name="sumberdana" class="form-control" id="sumberdana" placeholder="sumberdana"
                                value="{{ $ijin->SUMBERDANAI }}" required>
                            </div>
                        </div>
