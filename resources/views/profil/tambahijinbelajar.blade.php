...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-0">Tambah Ijin Belajar</h4>
                    <hr class="my-3">
                    <form method="POST" action="{{ route('tambahIjinBelajar') }}" class="forms-sample">
                        @csrf
                      <!-- Input tersembunyi untuk menangkap idDosen dari URL -->
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-7">
                                ...
                                <input type="text" name="berizin" class="form-control" id="berizin" placeholder="berizin" required>
                            </div>
                            <div class="mb-3 col-md-7">
