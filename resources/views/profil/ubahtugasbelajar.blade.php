...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Tugas Belajar</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr class="my-3">
                    <form method="POST" action="{{ route('editTugasBelajar') }}" class="forms-sample">
                        @csrf
                      <!-- Input tersembunyi untuk menangkap idDosen dari URL -->
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-7">
                                ...
                                value="{{ $tugas->NIDN }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="tugas" class="form-label">TUGAS </label>
                                <input type="text" name="tugas" class="form-control" id="tugas" placeholder="tugas" 
                                value="{{ $tugas->TUGAS }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                            ...
                            <div class="mb-3 col-md-7">
                                ...
                                value="{{ $tugas->TAHUNMULAI }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                            ...
                            <div class="mb-3 col-md-7">
                                ...
                                value="{{ $tugas->SUMBERDANAI }}" required>
                            </div>
                        </div>
