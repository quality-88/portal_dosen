...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-0">Fungsi </h4>
                    <hr class="my-3">
                    <form method="POST" action="{{ route('editFungsi') }}" class="forms-sample">
                        @csrf
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-7">
                                ...
                                <select class="form-select" id="lokasi" name="jabatan" aria-label="Default select example">
                                    ...
                                    <option value="{{ $jabatan->jabatan }}" {{ $jabatan->jabatan == $fungsi->JABATANDOSEN ? 'selected' : '' }}>
                                        {{ $jabatan->jabatan }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-md-7">
                                ...
                                <input type="nomorsk" name="nomorsk" class="form-control" id="nomorsk" value="{{ $fungsi->NOSK }}" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="tmt" class="form-label">TMT</label>
                                <input type="text" name="tmt" class="form-control" id="tmt" value="{{ $fungsi->TMT }}" required>
                            </div>                                                            
                        </div>
