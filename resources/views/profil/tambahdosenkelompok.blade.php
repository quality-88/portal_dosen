...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Dosen Kelompok</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-0">Tambah Dosen Kelompok Mata Kuliah</h4>
                    <hr class="my-3">
                      ...
                      <!-- Input tersembunyi untuk menangkap idDosen dari URL -->
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-7">
                                ...
                                <input type="text" name="ipa" class="form-control" id="ipa" placeholder="ipa" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="ips" class="form-label">IPS </label>
                                <input type="text" name="ips" class="form-control" id="ips" placeholder="ips" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="bahasa" class="form-label">Bahasa</label>
                                <input type="text" name="bahasa" class="form-control" id="bahasa" placeholder="bahasa" required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="matematika" class="form-label">Matematika</label>
                                <input type="text" name="matematika" class="form-control" id="matematika" placeholder="matematika" required>
                            </div>
                        </div>
