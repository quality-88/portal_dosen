        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr class="my-3">
                    <form method="POST" action="{{ route('tambahPenelitian') }}" class="forms-sample">
                        @csrf
                      <!-- Input tersembunyi untuk menangkap idDosen dari URL -->
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-7">
                                ...
                                <input type="text" name="bidang" class="form-control" id="bidang" placeholder="bidang" required>
                            </div>
                            <div class="mb-3 col-md-7">
                            ...
                            <div class="mb-3 col-md-7">
                                ...
                                <input type="text" name="publikasi" class="form-control" id="publikasi" placeholder="publikasi" required>
                            </div>
                        </div>
