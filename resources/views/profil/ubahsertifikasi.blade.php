...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-0">SERTIFIKASI DOSEN </h4>
                    <hr class="my-3">
                    <form method="POST" action="{{ route('editSertifikasi') }}" class="forms-sample">
                        @csrf
                      <!-- Input tersembunyi untuk menangkap idDosen dari URL -->
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-7">
                                ...
                                <input type="text" name="jenis" class="form-control" id="jenis" placeholder="jenis sertifikasi" 
                                value="{{ $sertifikat->JenisSertifikasi ?? '' }}"required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="bidang" class="form-label">Bidang Studi</label>
                                <input type="text" name="bidang" class="form-control" id="bidang" placeholder="Bidang Studi" 
                                value="{{ $sertifikat->BidangSertifikasi ?? '' }}"required>
                            </div>
                            <div class="mb-3 col-md-7">
                                <label for="nomorsk" class="form-label">Nomor SK</label>
                                <input type="text" name="nomorsk" class="form-control" id="nomorsk" value="{{ $sertifikat->NoSK ?? '' }}" required>
                            ...
                            <div class="mb-3 col-md-7">
                                ...
                                value="{{ $sertifikat->TahunSertifikasi ?? '' }}" required>
                            </div>
                        </div>
