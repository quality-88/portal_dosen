...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-4">Rekap Mahasiswa Aktif /Universitas</h4>
...
<script>
    ...
    function downloadPDF() {
        ...
        doc.text(`Rekap Jumlah Mahasiswa Aktif`, 20, 80);
        doc.setFontSize(10);
        doc.text(`TA: ${ta_start}}`, 20, 120);
        ...
        const fileName = `Rekap Keseluruhan Mahasiswa_${universitas}_TA${ta_start}_${formattedDate}.pdf`;
        doc.save(fileName);
    }
    ...
    function downloadExcel() {
        ...
        wb.Props = {
            Title: "Rekap Keseluruhan Mahasiswa Aktif",
