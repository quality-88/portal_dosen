...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-4">Rekap Mahasiswa</h4>
                    <form class="row g-5" action="{{ route('viewRekap') }}" method="POST">
                        @csrf
                        <div class="col-md-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <button class="btn btn-primary btn-lg float-end" style="margin-right: 10px;" onclick="downloadExcel()">Download Excel</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function downloadPDF() {
        ...
        doc.text(`Rekap Jumlah Mahasiswa: ${tipeKelas}` , 20, 80);
        doc.setFontSize(10);
        ...
        const fileName = `Rekap Keseluruhan Mahasiswa_${universitas}_TA${ta_start}-${ta_end}_${formattedDate}.pdf`;
        doc.save(fileName);
        @endif
    }
    ...
    function downloadExcel() {
        ...
        const currentDate = new Date();
        const formattedDate = currentDate.toLocaleDateString('en-US');
        const fileName = `Rekap Keseluruhan Mahasiswa_${universitas}_TA${ta_start}-${ta_end}_${formattedDate}.xlsx`;
