...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-4">Jumlah Calon Mahasiswa dan Mahasiswa</h4>
                    <form class="row g-5" action="{{ route('viewjlhMahasiswa') }}" method="POST">
                        @csrf
                        <div class="col-md-4">
...
<script>
    ...
    @endif
        ...
        var headers = ['Tahun Akademik', 'Jumlah Calon Pendaftar', 'Jumlah Pendaftar Lulus Seleksi', 'Jumlah Mahasiswa Baru', 'Jumlah Mahasiswa'];
        var data = [];
    ...
    @endif
        ...
        var ws_data = [['Tahun Akademik', 'Jumlah Calon Pendaftar', 'Jumlah Pendaftar Lulus Seleksi', 'Jumlah Mahasiswa Baru', 'Jumlah Mahasiswa']];
