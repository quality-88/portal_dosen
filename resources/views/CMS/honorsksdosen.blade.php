...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="mb-0">Honor SKS Dosen S2 </h4>
                    <hr class="my-4">
                    <form class="row g-5" action="#" method="POST" id="honor" >
                        ...
                        <div class="col-md-4">
                            <label for="honors2" class="form-label">Honor S2</label>
                            <input type="text" class="form-control" id="honors2" name="honors2" >
                        </div>
                        <div class="col-md-12">
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-0">Setting Honor SKS Dosen S2</h4>
                <hr class="my-4">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>{{ $j->TA }}</td>
                            <td>{{ $j->semester }}</td>
                            <td>{{ number_format($j->HonorS2, 3, ',', '.') }}</td>
                            <td>
            ...
            success: function(response) {
                ...
                if (response && response.success) {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = "{{ route('showSettingHonor') }}";
                    });
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response && response.success) {
                        ...
                        Swal.fire({
                            title: 'Error!',
                            text: 'Failed to update HONORSKSS2',
                            icon: 'error',
                            confirmButtonText: 'OK'
                        });
                    }
                ...
                error: function(xhr, status, error) {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'An error occurred while updating HONORSKSS2',
                        icon: 'error',
                        confirmButtonText: 'OK'
                    });
                }
