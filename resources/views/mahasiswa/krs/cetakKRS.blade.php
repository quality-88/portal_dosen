        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-5" action="{{ route('cetakKRS') }}" method="POST" id="krsForm">
                        @csrf
                        <div class="col-md-4">
                            <label for="npm" class="form-label">NPM</label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="npm" name="npm"
                                    placeholder="Masukkan Nama atau NPM" required>
...
<style>
    #resultList {
        ...
        overflow-y: auto;
        /* Add a scrollbar when the list overflows */
        position: absolute;
        width: 100%;
        /* Make the list full-width */
        z-index: 1000;
        /* Adjust the z-index to make sure the list appears above other elements */
        background-color: #ffffff;
        /* Set a background color */
        border-radius: 5px;
        /* Optional: Add border-radius for rounded corners */
        top: calc(100% + 10px);
        /* Position the resultList below the input field */
        left: 0;
        /* Align the left edge of resultList with the left edge of its containing block */
        padding: 0;
        /* Remove padding to align with the input field */
        margin: 0;
        /* Remove margin to align with the input field */
    }
    ...
    #resultList li {
        ...
        cursor: pointer;
        /* Change the cursor to a pointer for better user experience */
        list-style: none;
...
<script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(function (result) {
                        resultList.append('<li data-id="' + result.npm + '">' + result.npm + ' - ' + result.nama +
                            '</li>');
                    });
                },
    ...
    $(document).on('click', '#resultList li', function () {
        ...
        $('#resultList').hide();
        // Aktifkan tombol Submit setelah pencarian berhasil
