...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-0">Rincian KRS Mahasiswa</h4>
                    <hr class="my-4">
                    <form class="row g-3" action="{{ route('rincianKRS') }}" method="POST">
                        @csrf
                        <div class="col-md-6">
                            <label for="idkampus" class="form-label">ID Kampus</label>
                            <select class="form-select" id="idkampus" name="idkampus" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="prodi" name="prodi" onchange="updateFakultas()" required>
                        ...
                        <div class="col-md-6">
                            <label for="statusMHS" class="form-label">Status Mahasiswa</label>
                            <select class="form-select" id="statusMHS" name="statusMHS" aria-label="Default select example">
