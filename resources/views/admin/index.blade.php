    ...
    <div class="row">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <h5 class="card-title">Jumlah Dosen 2023</h5>
                    <h3>{{ $dosen }}</h3>
                </div>
                <div class="card-footer">
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Grafik Mahasiswa Aktif per Prodi Tahun 2023</h4>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Grafik Mahasiswa Lulus per Prodi Tahun 2023</h4>
