...
Route::group(['middleware' => 'auth'], function () {
  ...
  Route::get('/input/tambahmatkul/searchIdmk', [ProfilController::class, 'searchIdmk'])->name('searchIdmk');
  ...
  Route::get('input/searchMatkul', [ProfilController::class, 'searchMatkul'])->name('searchMatkul');
  //edit profil dosen
